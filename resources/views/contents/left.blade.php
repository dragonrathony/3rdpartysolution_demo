...
-->
                                ...
                                <div class="flex-shrink-0 ms-2">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                         data-kt-menu="true" id="kt_menu_613a48b878fea">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid"
                                                            ...
                                                            data-dropdown-parent="#kt_menu_613a48b878fea"
                            ...
                            <div class="m-0">
                                ...
                                <div class="mb-10">
                                    <!--begin::Item-->
                                    <a href="../dist/pages/projects/project.html"
                                    ...
                                    <a href="../dist/pages/projects/project.html"
                                       class="custom-list d-flex align-items-center px-5 py-4">
                                        ...
                                        <div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/svg/brand-logos/rgb.svg"
                                                                         class="h-50 align-self-center" alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <!--begin::Title-->
                                            <h5 class="custom-list-title fw-bold text-gray-800 mb-1">RGB
                                                Cloud System</h5>
                                            <!--end::Title-->
                                            <!--begin::Link-->
																...
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24"
																		...
																		<path opacity="0.3"
                                                                              ...
                                                                              fill="black"/>
																		<path d="M20 7H3C2.4 7 2 6.6 2 6V3C2 2.4 2.4 2 3 2H20C20.6 2 21 2.4 21 3V6C21 6.6 20.6 7 20 7ZM7 9H3C2.4 9 2 9.4 2 10V20C2 20.6 2.4 21 3 21H7C7.6 21 8 20.6 8 20V10C8 9.4 7.6 9 7 9Z"
                                                                              fill="black"/>
																	</svg>
																</span>
                                                                <!--end::Svg Icon-->
                    ...
                    <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                        ...
                        <div class="mx-5">
                            ...
                            <div class="text-center pt-10 mb-20">
                                ...
                                <!--end::Title-->
                                <!--begin::Description-->
                                <p class="text-gray-400 fs-6 fw-bold mb-10">There are no customers added
                                    yet.
                                    <br/>Kickstart your CRM by adding a your first customer</p>
                                <!--end::Description-->
                                <!--begin::Action-->
                                <a href="#" class="btn btn-primary" data-bs-target="#kt_modal_upgrade_plan"
                        ...
                        <div class="mx-5">
                            ...
                            <div class="mb-12">
                                ...
                                <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="../dist/widgets/lists.html"
                                           class="fw-bolder text-gray-800 text-hover-primary fs-6">Project
                                            Launch</a>
                                ...
                                <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="../dist/widgets/lists.html"
                                           class="fw-bolder text-gray-800 text-hover-primary fs-6">Client
                                            Meeting</a>
                                ...
                                <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="../dist/widgets/lists.html"
                                           class="fw-bolder text-gray-800 text-hover-primary fs-6">Real
                                            Estate App</a>
                                    ...
                                    <span class="svg-icon svg-icon-primary me-5">
															...
															<span class="svg-icon svg-icon-1 svg-icon-primary">
																<svg xmlns="http://www.w3.org/2000/svg" width="23"
																	...
																	<path d="M21 13V13.5C21 16 19 18 16.5 18H5.6V16H16.5C17.9 16 19 14.9 19 13.5V13C19 12.4 19.4 12 20 12C20.6 12 21 12.4 21 13ZM18.4 6H7.5C5 6 3 8 3 10.5V11C3 11.6 3.4 12 4 12C4.6 12 5 11.6 5 11V10.5C5 9.1 6.1 8 7.5 8H18.4V6Z"
                                                                          fill="black"/>
																	<path opacity="0.3"
