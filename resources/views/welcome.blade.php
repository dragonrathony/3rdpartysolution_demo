                                ...
                                <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                        ...
                                        <div class="mb-3 mb-md-0 fw-bold">
                                            ...
                                            <div class="fs-6 text-gray-700 pe-7">Login into Jet Admin Dashboard to make
...
<button id="kt_explore_toggle"
        ...
        title="Upgrade to Seven HTML Pro" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click"
    ...
    <div class="card shadow-none rounded-0 w-100">
        ...
        <div class="card-body" id="kt_explore_body">
            ...
            <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto"
                ...
                <!--end::Licenses-->
                <!--begin::Link-->
                <a href="https://keenthemes.com/products/seven-html-pro" class="btn btn-lg explore-btn-primary w-100">Upgrade
                    to
...
@include('modals.invite_friends')

@include('modals.create_app')

@include('modals.upgrade_plan')
<!--end::Modals-->
<!--begin::Scrolltop-->
